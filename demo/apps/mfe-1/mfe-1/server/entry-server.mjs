...
import React__default, { createContext, forwardRef, createElement, Children, isValidElement, cloneElement, useEffect, useState, useRef, useCallback, Fragment as Fragment$1, useMemo, useLayoutEffect, useReducer, useContext } from "https://esm.sh/react@18.2.0";
import * as $yHMN2$reactdom__default from "https://esm.sh/react-dom@18.2.0";
import $yHMN2$reactdom__default__default, { flushSync } from "https://esm.sh/react-dom@18.2.0";
import { NavLink, useLoaderData } from "https://esm.sh/react-router-dom@6.10.0";
